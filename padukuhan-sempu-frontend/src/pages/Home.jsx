  ...
  return (
    <main>
      ...
      <div className="sticky">
        ...
        <div>
          awan
          <img className="top-3/4 lg:top-3/4 absolute h-[20vh] md:h-[40vh] w-screen" src={awan} alt="" />
        </div>
      </div>
          ...
          <div className="text-center w-[50%]">
            <Fade direction="right" delay={300}>
              <p className="font-sans ">
                Padukuhan Sempu adalah sebuah padukuhan yang terletak di Kalurahan Pringombo, Kecamatan Rongkop, Kabupaten Gunungkidul,
                di Provinsi Daerah Istimewa Yogyakarta, Indonesia.
                Kabupaten Gunungkidul terletak di bagian selatan Pulau Jawa dan terkenal
                dengan keindahan alamnya, terutama pantai-pantai yang menakjubkan.
                Sempu adalah salah satu dari beberapa padukuhan di Kalurahan Pringombo,
                yang terdiri dari beberapa rumah penduduk. Padukuhan ini berada di kawasan pedesaan yang didominasi oleh pertanian,
                terutama penghasilan padi, jagung, dan tanaman lainnya.
              </p>
            </Fade>
          </div>
        </div>
